      ...
      <section id="projects" className="bg-blue pt-20 pb-20">
        <div className="max-w-[80%] md:max-w-[70%] mx-auto text-left  ">
          <div className=" flex flex-col gap-5">
                ...
                >
                  ...
                  <div className="flex flex-col gap-2 md:px-5 pb-5 md:pb-0 items-center">
                    <a
                      ...
                      target="_blank"
                      className="font-bold group-hover:text-blue"
                    >
                      {project.title}
                    </a>
                    <p className="px-2 text-center text-sm md:max-w-[70%]">
                      {project.description}
                    </p>
            ...
            <h3 className="font-bold text-primary text-center text-2xl mt-12">
              Other Noteworthy Projects...
            </h3>

            <button className="p-1 bg-blue hover:bg-white hover:border-primary border-2 md:w-[25%] flex mx-auto justify-center rounded-lg text-white hover:text-blue text-lg font-semibold transition-all duration-75 ease-linear">
              <Link to={"/ProjectArchive"}>View Project Archive</Link>
            </button>
          </div>
        </div>
      </section>
